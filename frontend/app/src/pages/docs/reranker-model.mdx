...
To use vLLM rerankers, you need to provide the **api_url** of the reranker API as the following JSON format in **Advanced Settings**:
...
To use Xinference rerankers, you need to provide the **api_url** of the reranker API as the following JSON format in **Advanced Settings**:
